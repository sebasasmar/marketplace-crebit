...
// This key is now loaded from your .env.local file
// VITE_WOMPI_PUBLIC_KEY=pub_prod_y09XX0vDVnv1A25FWQcrtCGCQPyng8DHQ
const WOMPI_PROD_PUBLIC_KEY = import.meta.env.VITE_WOMPI_PUBLIC_KEY;
